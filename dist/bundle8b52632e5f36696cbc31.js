...
async function copyText(e) {
  console.log(_text__WEBPACK_IMPORTED_MODULE_0__.currentText);
  e.preventDefault();
  const { clipboard } = navigator;

  await clipboard.writeText(_text__WEBPACK_IMPORTED_MODULE_0__.currentText);
}
...
/* harmony export */ });
/* harmony import */ var _emojiPicker__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./emojiPicker */ "./src/emojiPicker.js");
...
const setCurrentEmoji = (emoji) => {
  ...
  (0,_emojiPicker__WEBPACK_IMPORTED_MODULE_0__.closeEmojiPicker)();
  currentSelectedEmoji = emoji;

  _emojiPicker__WEBPACK_IMPORTED_MODULE_0__.currentSelection.textContent = currentSelectedEmoji;
};
...
async function getScreenShot(e) {
  ...
  __webpack_require__.e(/*! import() */ "vendors-node_modules_html2canvas_dist_html2canvas_js").then(__webpack_require__.t.bind(__webpack_require__, /*! html2canvas */ "./node_modules/html2canvas/dist/html2canvas.js", 23)).then(async (data) => {
...
/* harmony import */ var _controlledInput__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./controlledInput */ "./src/controlledInput.js");
...
function renderBoardWithCurrentEmojiText() {
  ...
  let currentTextArr = _text__WEBPACK_IMPORTED_MODULE_0__.currentText.split("\n");
  currentTextArr = currentTextArr.map((arr) => {
    return (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.splitEmoji)(arr);
  });

  if (tiles) {
    for (let i = 0; i < _controlledInput__WEBPACK_IMPORTED_MODULE_2__.height; i++) {
      for (let j = 0; j < _controlledInput__WEBPACK_IMPORTED_MODULE_2__.width; j++) {
        if (tiles[i * _controlledInput__WEBPACK_IMPORTED_MODULE_2__.width + j]) {
          tiles[i * _controlledInput__WEBPACK_IMPORTED_MODULE_2__.width + j].textContent = currentTextArr[i][j];
        }
      }
    }
  }
...
undoBtn.addEventListener("click", () => {
  undo();
  (0,_text__WEBPACK_IMPORTED_MODULE_0__.setCurrentText)(getCurrentItem());
...
currentSelection.addEventListener("click", () => {
  if (!picker) {
    ...
    __webpack_require__.e(/*! import() */ "vendors-node_modules_picmo_dist_index_js").then(__webpack_require__.bind(__webpack_require__, /*! picmo */ "./node_modules/picmo/dist/index.js")).then(async ({ createPicker }) => {
      // Create the picker
...
/* harmony import */ var _emojiArtGeneratorState__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./emojiArtGeneratorState */ "./src/emojiArtGeneratorState.js");
...
const emojifyImage = function (e) {
  ...
  setTimeout(function () {
    ...
    (0,_text__WEBPACK_IMPORTED_MODULE_3__.setCurrentText)(newTextToSet);
    (0,_emojiArtGeneratorState__WEBPACK_IMPORTED_MODULE_1__.updateHistory)(_text__WEBPACK_IMPORTED_MODULE_3__.currentText);

    (0,_emojiArtGeneratorState__WEBPACK_IMPORTED_MODULE_1__.renderBoardWithCurrentEmojiText)();
    btn.disabled = false;
...
/* harmony export */ });
/* harmony import */ var _controlledInput__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./controlledInput */ "./src/controlledInput.js");
...
function setCurrentText(newText) {
  if (newText) {
    ...
    if (tiles) {
      for (let i = 0; i < _controlledInput__WEBPACK_IMPORTED_MODULE_0__.height; i++) {
        for (let j = 0; j < _controlledInput__WEBPACK_IMPORTED_MODULE_0__.width; j++) {
          currentText += tiles[i * _controlledInput__WEBPACK_IMPORTED_MODULE_0__.width + j].textContent;
        }
        currentText += "\n";
      }
    }
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("8b52632e5f36696cbc31")
/******/ 	})();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=bundle8b52632e5f36696cbc31.js.map